// Page Séries: filtres combinables + pagination + favoris
import { useQuery } from '@tanstack/react-query'
import { discoverSeries, getFavorites } from '../services/api'
import { useState } from 'react'
import MovieGrid from '../components/MovieGrid'
import SkeletonMovieCard from '../components/SkeletonMovieCard'
import FavoriteButton from '../components/FavoriteButton'

// Construit la requête Discover TV à partir des filtres UI
function Series() {
  ...
  // Requête Discover Series (avec cache par clés de filtres)
  const { data, isLoading } = useQuery({
    queryKey: ['series-discover', page, sortBy, year, ratingMin, genre],
    queryFn: () =>
      discoverSeries({
        sort_by: sortBy,
        page,
      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-3 rounded-md border border-neutral-800 bg-neutral-900/60 p-3">
          ...
          >
            ...
            <option value="first_air_date.desc">Première diffusion décroissante</option>
